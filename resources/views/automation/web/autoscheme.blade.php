...
<div class="case task">
	<form target="#">
		<ul class="clearfix">
            ...
            <input type="text" class="input-sm form-control" name="start" id="execBeginDate" validate="required;len[1:30]" />
            <span class="input-group-addon">到</span>
            <input type="text" class="input-sm form-control" name="end" id="execEndDate" validate="required;len[1:30]" />
            </div>
            </div>
            </li>
