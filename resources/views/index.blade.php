		...
		<ol class="clearfix">
			<li>
				<div class="clearfix tip">
					<h4 class="clearfix">WebUI自动化测试</h4>
			...
			<li>
				<div class="clearfix tip">
					<h4 class="clearfix">接口自动化测试</h4>
					<span id="apiTaskPieCount">0</span>
				</div>
				<div id="apiTaskPie" style="width: 100%; height: 180px;"></div>
				<ul class="clearfix" id="apiState">
					<li class="mission-not"><span></span>未执行<b>0</b></li>
					<li class="mission-ing"><span></span>执行中<b>0</b></li>
					<li class="mission-success"><span></span>执行成功<b>0</b></li>
					<li class="mission-fail"><span></span>执行失败<b>0</b></li>
			...
			<li>
				<div class="clearfix tip">
					<h4 class="clearfix">App自动化测试</h4>
					<span id="appTaskPieCount">0</span>
				</div>
				<div id="appTaskPie" style="width: 100%; height: 180px;"></div>
				<ul class="clearfix" id="appState">
					<li class="mission-fail"><span></span>执行失败<b>0</b></li>
					<li class="mission-not"><span></span>未执行<b>0</b></li>
					<li class="mission-ing"><span></span>执行中<b>0</b></li>
					<li class="mission-success"><span></span>执行成功<b>0</b></li>
			...
			<li>
				<div class="clearfix tip">
					<h4 class="clearfix">调度中心任务</h4>
					<span id="dispatchTaskPieCount">0</span>
				</div>
				<div id="dispatchTaskPie" style="width: 100%; height: 180px;"></div>
				<ul class="clearfix" id="dispatchState">
					<li class="mission-not"><span></span>未执行<b>0</b></li>
					<li class="mission-ing"><span></span>执行中<b>0</b></li>
					<li class="mission-success"><span></span>执行成功<b>0</b></li>
					<li class="mission-fail"><span></span>执行失败<b>0</b></li>
	...
	<div class="script cleafix">
		...
		<div class="count clearfix">
			<ul class="clearfix ">
				<li class="num">
					<div>WebUI测试:</div>
					<span id="scriptCount">0</span>脚本数
				</li>
			...
			<ul class="clearfix ">
				<li class="num">
					<div>Api测试:</div>
					<span id="apiScriptCount">0</span>脚本数
				</li>
				<!-- <li class="send-img"><i></i></li>
				<li class="receive-img"><i></i></li>
				<li class="send"><b></b>推送: <span>22</span></li>
			...
			<ul class="clearfix ">
				<li class="num">
					<div>App测试:</div>
					<span id="appScriptCount">0</span>脚本数
				</li>
				<!-- <li class="send-img"><i></i></li>
				<li class="receive-img"><i></i></li>
				<li class="send"><b></b>推送: <span>22</span></li>
			...
			<ul class="clearfix ">
				<li class="num">
					<div>调度中心:</div>
					<span id="dispatchScriptCount">0</span>任务数
				</li>
				<!-- <li class="send-img"><i></i></li>
				<li class="receive-img"><i></i></li>
				<li class="send"><b></b>推送: <span>22</span></li>
