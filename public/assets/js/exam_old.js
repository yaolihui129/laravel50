    ...
    $.ajax({
        ...
        success: function (backData) {
            ...
            if (backData.flag == "0") {
                ...
                $(".title_content").html(answerCount + "." + firstQuestion.title + "(单选题)");
...
function hideModelWright() {
    ...
    if (nextQuestion) {
        ...
        if ($(".title_content").attr("examtype") == 1) {
            $(".title_content").html(answerCount + "." + nextQuestion.title + "(单选题)");
        ...
        } else if ($(".title_content").attr("examtype") == 2) {
            $(".title_content").html(answerCount + "." + nextQuestion.title + "(多选题)");
            ...
            $(".title_content").html(answerCount + "." + nextQuestion.title + "(判断题)");
    ...
    if (answerCount > totalPapreCounts) {
        ...
        var md5String = "c1761d6fa515f3390e52bf397e7a3768";
