...
AutoScriptUtil = function(me) {
	...
	return me = {
        ...
        new : function(id) {
            ...
            me.openNewForm("scriptform", yes, [ "新增脚本", "取消" ]);
        ...
        uploadParamNew : function(id) {
            ...
            layer.open({
                ...
                area : [ "830px", "460px" ], // 宽高
                offset : [ '50px' ],
                content : "/auto/web/script/uploadParamNew"
            });
        },
		...
		//新增脚本form
        openNewForm : function(optType, yes, btn) {
            AutoScriptDetailUtil.init(optType);
            var formCss = "";
            switch (optType) {
                case "scriptParam":
	...
	return me = {
		...
		createAutozTree : function() {
			...
			CommonUtil.requestService(proTreeUrl, "", true, "get", function(
				...
				//新增脚本配置的选择项数据绑定
                $("#productSelectNew").off("click");
                $("#productSelectNew").on("click", function() {
                    $(".dropdown-menu").toggle();
                });
