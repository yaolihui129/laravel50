...
use App\Services\ApiScriptService;
...
class ApiScriptController extends Controller {
	private $root = '/database/schemes/easyTestApi/script/';
	...
	public function store(Request $request) {
		...
		if ($productId && $projectId) {
			...
			$asService = new ApiScriptService();
			$user = $request->user ();
	...
	public function show($id) {
		//
		return view ( 'api.web.apiscript_edit' );
	}
	...
	public function edit(Request $request, $id) {
		...
		return view ( 'api.web.apiscript_edit' )->withScriptcode ( $code );
	}
	...
	public function getScriptTree(Request $request) {
		...
		if (! $nodeId) {
			...
			$scriptService = new ApiScriptService();
	...
	public function getScriptText(Request $request) {
		...
		return view ( "api.web.apiscript_diff" )->with ( $pages );
	}
